...
const kitTypeImportPathCache = new Map();
/**
...
function getKitTypeImportPath(ts, fileName) {
    var _a;
    ...
    try {
        const packageJsonPath = (_a = ts.resolveModuleName('@sveltejs/kit/package.json', fileName, { moduleResolution: ts.ModuleResolutionKind.NodeJs, resolveJsonModule: true }, ts.sys).resolvedModule) === null || _a === void 0 ? void 0 : _a.resolvedFileName;
...
function upsertKitClientHooksFile(ts, fileName, basename, clientHooksPath, getSource, surround) {
    ...
    const isTsFile = basename.endsWith('.ts');
    const exports = findExports(ts, source, isTsFile);
    addTypeToFunction(ts, exports, surround, insert, isTsFile, 'handleError', `import('${kitTypeImportPath}').HandleClientError`);
    return { addedCode, originalText: source.getFullText() };
}
...
function upsertKitUniversalHooksFile(ts, fileName, basename, universalHooksPath, getSource, surround) {
    ...
    const isTsFile = basename.endsWith('.ts');
    const exports = findExports(ts, source, isTsFile);
    addTypeToFunction(ts, exports, surround, insert, isTsFile, 'reroute', `import('${kitTypeImportPath}').Reroute`);
    return { addedCode, originalText: source.getFullText() };
}
